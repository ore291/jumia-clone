<template>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center space-x-2 text-gray-400 text-sm">
      <router-link to='/' class="hover:underline hover:text-gray-600">Home</router-link>
      <span>
      ...
      <a href="#" class="hover:underline hover:text-gray-600">{{product.category}}</a>
      <span>
        <svg class="h-5 w-5 leading-none text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        </svg>
  ...
  <div class="container px-5 py-5  ">
    <div class="lg:w-4/5 mx-auto flex flex-wrap ">
      ...
      <div class="lg:w-3/5  p-3 lg:py-6 mt-1 lg:mt-0 ">
        ...
        <div class="flex">
          <span class="title-font font-medium text-2xl text-gray-900"><del>&#8358;</del
...
<script>
import {HeartCircle } from 'mdue'

export default {
   computed: {
    product(){
      return this.$store.getters.getProduct(parseInt(this.$attrs.productID));
      }
  },
  components:{
    HeartCircle
