<template>
<div class="w-full sm:w-48 bg-white p-1 hover:shadow-xl sm:transform sm:transition hover:scale-105 cursor-pointer mb-2">
    <div class="relative mb-1">
        <span class="text-xs absolute mt-1 min-w-10  right-[8px] text-disc bg-discbg py-1 px-1.5 font-medium align-top">-40%</span >
